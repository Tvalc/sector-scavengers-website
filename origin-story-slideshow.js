  ...
  var SLIDES = [
    {
      ...
      tag: "01 · Layoffs",
      caption: "2026. The AI does your job better. HR books your exit interview.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Story-Panel-2.png",
      tag: "02 · Severance",
      caption: "Severance comes with a brochure. Sleep through the bad years. Wake up rich.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Panel-3.png",
      tag: "03 · Status symbol",
      caption: "The rich freeze first. Cryo becomes a tourist attraction.",
    },
    {
      src: "../media/origin-story/SS-Background-BudgetCryo-Origin-Panel-4.png",
      tag: "04 · Debt paper",
      caption: "Then a bank bundles your nap into a bond. Your sleep is somebody's return.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Warehouse-Panel-5.png",
      tag: "05 · Warehouse",
      caption: "A shelf holds a person the way it holds a crate. Pods stack like SKUs.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Warehouse-Panel-6.png",
      tag: "06 · Fees accrue",
      caption: "Storage fees accrue while you dream. Power. Air. Coolant. The bill climbs.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Warehouse-Panel-6b.png",
      tag: "06 · Underwater",
      caption: "You sleep through your own foreclosure.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-ShipLoad-Panel-7.png",
      tag: "07 · The lot",
      caption: "A broker prints a lot. Warm bodies included. Still under contract.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-ShipLoad-Panel-7b.png",
      tag: "07 · Winning bid",
      caption: "Salvage Co. wins the auction. Logo you've never seen.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-ShipLoad-Panel-7c.png",
      tag: "07 · No jurisdiction",
      caption: "Signatures happen in orbit. No jurisdiction. No appeal.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-ShipLoad-Panel-7d.png",
      tag: "07 · Manifest number",
      caption: "Transfer complete. You're a manifest number now.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Wakeup-Panel-8.png",
      tag: "08 · Thaw",
      caption: "Thaw alarms go off in batches. Millions wake to the same due date.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-ShipLoad-Panel-8b.png",
      tag: "08 · Clock starts",
      caption: "Suit seals. Airlock clock starts. You're already late on the rent.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-SalvageRun-Panel-9.png",
      tag: "09 · The commute",
      caption: "A shuttle drops you at the junk tide line. Welcome to the new commute.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-SalvageRun-Panel-9b.png",
      tag: "09 · The math",
      caption: "You burn fuel to earn scrap. The math gets ugly fast.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-SalvageRun-Panel-9c.png",
      tag: "09 · Hull talk",
      caption: "Then the hull starts talking back.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Boarding-Panel-10.png",
      tag: "10 · The mouth",
      caption: "The derelict's mouth is a dark rectangle in a hull that used to be proud.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Boarding-Panel-10b.png",
      tag: "10 · You cross",
      caption: "You go through. Standing still also costs money.",
    },
    {
      src: "../media/origin-story/SS-Background-Origin-Boarding-Panel-10c.png",
      tag: "10 · Quiet wrong",
      caption: "The first room looks empty. Then the suit readouts twitch.",
    },
    {
      src: "../media/origin-story/SS-Website-Explore-Panel.png",
      tag: "11 · Pay the map",
      caption: "The map lies until you pay it in actions. Some doors pay out. Some bill you in blood.",
    },
  ];
